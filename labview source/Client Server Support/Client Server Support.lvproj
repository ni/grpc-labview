	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Servers" Type="Folder">
			<Item Name="Template Server" Type="Folder">
				<Item Name="Template Server.lvlib" Type="Library" URL="../Templates/Servers/Template Server/Template Server.lvlib"/>
			</Item>
		</Item>
		<Item Name="Clients" Type="Folder">
			<Item Name="Template Client" Type="Folder">
				<Item Name="Template Client.lvlib" Type="Library" URL="../Templates/Clients/Template Client/Template Client.lvlib"/>
			</Item>
		</Item>
